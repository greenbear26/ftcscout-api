...
def main():
    ...
    streamlit.title(":orange[FTC 2021: Freight Frenzy] Advancement Points Calculator")
    ...
    try:
        teams = request.getTeamsFromEvent(event_code, 2021)
    except:
        ftc_events = "https://ftc-events.firstinspires.org/2021#allevents"
